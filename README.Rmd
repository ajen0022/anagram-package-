...
You can install the development version of anagram from [GitHub](https://github.com/) with:
...
The output will be TRUE, indicating that "alert","alter" and "later" are indeed anagrams of each other. 
...
The output will be a boolean value (TRUE in this case), indicating whether anagram subsets meeting the specified minimum length requirement were found within the specified set of words.
